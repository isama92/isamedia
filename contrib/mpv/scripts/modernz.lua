...
local user_opts = {
    ...
    -- settings (mpv options) button mouse actions
    settings_mbtn_left_command = "script-binding select/menu",
...
layouts["default"] = function ()
    ...
    right_side_button("settings", 600)
...
local function osc_init()
    ...
    --settings (mpv options menu; uses the "more options" glyph as the icon font has no gear)
    ne = new_element("settings", "button")
    ne.content = icons.menu
    ne.tooltipF = locale.menu
    bind_buttons("settings")
