...
//! nowhere to cancel back to on the entry screen). Modelled on the Radarr setup
//! form, which is itself a deliberate duplicate — the app layer is never
//! generalised.
...
impl SetupForm {
    ...
    pub fn draw(&self, frame: &mut Frame, area: Rect) {
        ...
        self.form.draw(frame, form_area, "isamedia · sonarr");
