...
- order playback reports across a replaced player ([#52](https://github.com/isama92/isamedia/pull/52))
...
- *(jellyfin)* open the hovered movie/show in Radarr/Sonarr with u ([#45](https://github.com/isama92/isamedia/pull/45))
...
- clear stale jellyfin list on navigation and show loading placeholder ([#28](https://github.com/isama92/isamedia/pull/28))
